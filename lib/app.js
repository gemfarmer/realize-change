...
(function() {
  var FacebookStrategy, GoogleStrategy, TwitterStrategy, answer_requests, api, app, config, ensureAuthenticated, express, http, mongoose, passport, path, routes, user;
