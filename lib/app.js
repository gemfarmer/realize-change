...
(function() {
  var FacebookStrategy, GlobalAnswer, GoogleStrategy, TwitterStrategy, account_settings, answer_requests, api, app, config, ensureAuthenticated, express, fs, http, mongoose, passport, path, paypal, routes, user, vote;
...
paypal.init(configPaypal);
  ...
  app.get('/auth/google/callback', passport.authenticate('google', {
    ...
    var _ref;
    return res.redirect((_ref = req.session.redirectURL) != null ? _ref : '/main');
  });
