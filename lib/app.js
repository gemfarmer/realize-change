...
(function() {
  var FacebookStrategy, GlobalAnswer, GoogleStrategy, TwitterStrategy, answer_requests, api, app, config, detre, ensureAuthenticated, express, http, mongoose, passport, path, routes, user;
