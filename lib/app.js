...
(function() {
  var FacebookStrategy, GlobalAnswer, GoogleStrategy, TwitterStrategy, account_settings, answer_requests, app, config, ensureAuthenticated, express, fs, http, mongoose, passport, path, routes, user, vote;
