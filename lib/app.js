...
(function() {
  var FacebookStrategy, GlobalAnswer, GoogleStrategy, TwitterStrategy, account_settings, answer_requests, api, app, config, ensureAuthenticated, express, http, mongoose, passport, path, routes, user, vote;
